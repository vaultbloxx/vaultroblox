  ...
  const fetchUsers = async ({ queryKey }) => {
    ...
    try {
      const res = await fetch(
        `/api/rumman/v1/admin/get-all-users?skip=${skip}&search=${search.trim()}`
      );
            ...
            <div className="md:grid grid-cols-12 gap-12 pt-10">
              ...
              <div className="col-span-9">
                <div className="w-full">
                  <h1 className="text-lg font-medium text-zinc-200 2xl:text-2xl">
                    Users
                  </h1>
                  <p className="text-sm text-zinc-400 2xl:text-lg">
