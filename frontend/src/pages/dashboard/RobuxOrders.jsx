...
import RobuxOrderTable from "../../components/dashboard/RobuxOrderTable";

function RobuxOrders({ authUser }) {
              ...
              <div className="col-span-9">
                <div className="w-full rounded-md">
                  ...
                  <p className="text-sm 2xl:text-lg text-zinc-400">
                    View and manage your robux orders
                  </p>
                  <input
                    type="text"
