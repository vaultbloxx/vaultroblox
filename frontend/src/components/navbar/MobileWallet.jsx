  ...
  return (
    <div>
      <div className="flex items-center text-dryGray">
        <div className=" px-2 text-lg flex items-center justify-center h-10 bg-dry rounded-l-md">
          <p>${(buyerBalance + sellerBalance).toFixed(2)}</p>
        </div>
        <div
          onClick={() =>
            document.getElementById("mobile_wallet_modal").showModal()
          }
          className=" w-12 h-10 flex items-center justify-center  rounded-r-md bg-subMain cursor-pointer"
        >
          <img
          ...
          <div className="modal-box bg-dry">
            ...
            <div className=" mt-2 w-full flex  flex-col items-center">
              <div className=" pb-2 flex items-center justify-center">
                <MdOutlineAccountBalanceWallet className=" w-10 h-10 text-zinc-300" />
              </div>
                ...
                {currentTab === "deposit" && (
                  <div className=" pt-3">
                    <h1 className=" mt-2 text-center">
                      Buyer Balance:{" "}
                      <span className=" font-medium">${buyerBalance}</span>
                    </h1>
                    <form
                      onSubmit={(e) => {
                        e.preventDefault();
                    ...
                    <p className=" text-center text-sm mt-4 font-light opacity-70 leading-4">
